        ...
        <div className="flex h-20 items-center justify-center overflow-hidden">
          <div className="whitespace-nowrap animate-marquee">
            <span className="text-2xl font-bold bg-gradient-ai bg-clip-text text-transparent mx-8">
              Check back soon — something's on the way • Check back soon — something's on the way • Check back soon — something's on the way • Check back soon — something's on the way • Check back soon — something's on the way •
            </span>
          </div>
        </div>
      </div>
